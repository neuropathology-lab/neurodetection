...
main(input_dir = input_dir, out_dir = out_dir, model_isneuron_name = model_isneuron_name, img_ext = img_ext, plot_classification = plot_classification,
     save_annotations = save_annotations, use_hematoxylin=use_hematoxylin, pixel_um = pixel_um, edge_threshold = edge_threshold, closeness_threshold = closeness_threshold)